...
public class CameraPreviewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "Camera: " + mCamera + " cameraInfo: " + cameraInfo.toString());


        if (mCamera == null) {
            // Camera is not available, display error message
            setContentView(R.layout.camera_activity_camera_unavailable);
        } else {
...
//            int displayRotation = getDisplay().getRotation();
            ...
            CameraPreview cameraPreview = new CameraPreview(this, null, 0, mCamera, cameraInfo, 1);
    ...
    private Camera getCameraInstance(int cameraId) {
        ...
        try {
            ...
            String message = "Camera " + cameraId + " is not available: " + e.getMessage();
            Log.e(TAG, message);
